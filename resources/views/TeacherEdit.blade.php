                    ...
                    <form method="POST" action="{{ route('teachers.update', $teacher->id) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="first_name"
                                    value="{{ old('first_name', $teacher->account->first_name) }}" class="form-control">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Last Name</label>
                                <input type="text" name="last_name"
                                    value="{{ old('last_name', $teacher->account->last_name) }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" value="{{ old('email', $teacher->account->email) }}"
                                    class="form-control">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="hourly_rate"
                                    value="{{ old('hourly_rate', $teacher->hourly_rate) }}" class="form-control"
                                    step="0.01" min="0">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="status" class="form-select">
                                    <option value="active"
                                        {{ old('status', $teacher->account->status) == 'active' ? 'selected' : '' }}>Active
                                    </option>
                                    <option value="inactive"
                                        {{ old('status', $teacher->account->status) == 'inactive' ? 'selected' : '' }}>Inactive
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="zipcode" value="{{ old('zipcode', $teacher->zipcode) }}"
                                    class="form-control">
                            </div>
                        </div>
