            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="addStudentTabs" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link active" id="manual-tab" data-bs-toggle="tab" data-bs-target="#manual" type="button">Add Manually</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" id="csv-tab" data-bs-toggle="tab" data-bs-target="#csv" type="button">Import via CSV</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane fade" id="csv">
                            ...
                            <div class="mt-3">
                                ...
                                <code>first_name,last_name,parent_email,parent_phone,status,dob,gender,address,city,state,zipcode,teacher_id</code>
                            </div>
                        </div>
